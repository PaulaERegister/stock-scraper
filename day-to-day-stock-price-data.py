...
def scape_stock_prices(stock_list, stock_final, start, end):
    for i in range(11):
        try:
            stock = []
...
def main():
    ...
    stock_to_view = input("Enter a stock to view: (Ex: NSE/SUTLEJTEX)\n")
    stock_final = stock_final[stock_final['Name'] == stock_to_view]
